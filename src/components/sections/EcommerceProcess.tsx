...
const steps = [
  { icon: faMagnifyingGlass, title: "Discovery", desc: "Understanding your business, products, audience, and goals." },
  { icon: faClipboardList, title: "Planning", desc: "Creating the website structure, user journey, and functionality roadmap." },
  { icon: faPalette, title: "Design", desc: "Developing a premium user experience aligned with your brand." },
  { icon: faCode, title: "Development", desc: "Building a secure, responsive, and high-performing ecommerce platform." },
...
export default function EcommerceProcess() {
  return (
    <Section id="ecommerce-process" className="relative overflow-hidden">
      ...
      <Container className="relative !max-w-[1280px] 2xl:!max-w-[1600px]">
        ...
        {/* DESKTOP — pipeline with real cards beneath each node, fills vertical space */}
        <div className="relative mx-auto mt-20 hidden max-w-6xl lg:block">
          ...
          <div className="relative grid grid-cols-5 gap-5">
            {steps.map((step, i) => (
              ...
              >
                ...
                {/* real card body — adds vertical substance instead of floating text */}
          ...
          {/* status bar strip — second layer of content, fills the remaining space below */}
          <motion.div
