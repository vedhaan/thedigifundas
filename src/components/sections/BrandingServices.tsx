...
const stages: Stage[] = [
  {
    icon: faPenNib,
    title: "Logo Design",
    intro: "A logo is often the first visual element customers associate with your business. We create professional logo designs that reflect your brand personality, values, and vision.",
    lists: [
      {
        label: "Includes:",
        items: ["Custom Logo Concepts", "Brand Color Selection", "Typography Selection", "Logo Variations", "High-Resolution Files"],
      },
    ],
  },
  {
    ...
    intro: "Present your business professionally with a well-structured company profile that communicates your expertise, achievements, services, and vision.",
    lists: [
      { label: "Ideal For:", items: ["Corporate Presentations", "Business Proposals", "Investor Meetings", "Client Introductions"] },
      { label: "Includes:", items: ["Content Structuring", "Visual Design", "Brand Consistency", "Print & Digital Formats"] },
    ],
  },
  {
    icon: faBookOpen,
    title: "Catalogue & Brochure Design",
    intro: "Showcase your products and services through professionally designed catalogues and brochures that inform, engage, and influence purchasing decisions.",
    lists: [
      {
        label: "Includes:",
        items: ["Product Catalogues", "Service Brochures", "Corporate Brochures", "Marketing Collateral", "Product Presentation Layouts"],
      },
    ],
  },
  {
    ...
    intro: "Present your work professionally with customized portfolio designs that highlight your expertise, projects, and achievements.",
    lists: [
      { label: "Ideal For:", items: ["Agencies", "Designers", "Architects", "Consultants", "Creative Professionals"] },
      { label: "Includes:", items: ["Portfolio Layout Design", "Project Presentation", "Brand Alignment", "Digital & Print Formats"] },
    ],
  },
  {
    icon: faSignsPost,
    title: "Exhibition & Event Design",
    intro: "Create impactful brand experiences during exhibitions, trade shows, corporate events, and product launches.",
    lists: [
      {
        label: "Services Include:",
        items: ["Exhibition Stall Graphics", "Backdrop Designs", "Standee Designs", "Event Branding", "Display Panels", "Marketing Materials"],
      },
    ],
  },
  {
    ...
    intro: "Ensure consistency across all customer touchpoints through professionally designed brand assets.",
    lists: [
      {
        label: "Includes:",
        items: ["Business Cards", "Letterheads", "Presentation Templates", "Social Media Templates", "Packaging Concepts", "Brand Guidelines"],
      },
    ],
  },
];
...
export default function BrandingServices() {
  return (
    <Section id="branding-services" className="relative overflow-hidden">
      ...
      <Container className="relative !max-w-[1280px] 2xl:!max-w-[1600px]">
        ...
        {/* Flow map — 6 stages, evenly divides 3-col grid, same as Google Ads */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          {stages.map((stage, i) => (
            <div key={stage.title} className="flex flex-1 items-center justify-center">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="max-w-[90px] text-center font-heading text-[10px] font-semibold text-text-secondary 2xl:max-w-[100px] 2xl:text-xs">
                  {stage.title}
                </span>
              </div>
              {i < stages.length - 1 && (
                <FontAwesomeIcon icon={faArrowRight} className="mx-2 mb-6 h-3 w-3 shrink-0 text-accent-primary/40 2xl:mx-3 2xl:h-3.5 2xl:w-3.5" />
              )}
            </div>
          ))}
          <div className="flex flex-1 flex-col items-center gap-2">
            ...
            <span className="max-w-[90px] text-center font-heading text-[10px] font-semibold text-text-secondary/60 2xl:max-w-[100px] 2xl:text-xs">
              Feeds Back Into Assets
            </span>
          </div>
        </motion.div>

        {/* Service cards — supports optional second labeled list */}
