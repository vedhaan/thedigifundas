...
const faqs = [
  {
    ...
    a: "We can work with Mailchimp, Klaviyo, Brevo, ConvertKit, and other leading platforms.",
  },
  {
    q: "Can you create email content too?",
    a: "Yes. We handle strategy, copywriting, design direction, automation, and reporting.",
  },
];

export default function EmailMarketingFAQ() {
  const [open, setOpen] = useState<number | null>(0);

  return (
    <Section id="email-marketing-faq" bgSecondary className="relative overflow-hidden">
                ...
                >
                  ...
                  <span
                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full transition-colors duration-300 ${
                      isOpen ? "bg-accent-primary text-bg-primary" : "bg-bg-secondary text-accent-primary"
                    }`}
                  >
