...
const industries = [
  {
    ...
    icon: faGem,
    desc: "Promoting collections through creative storytelling and targeted campaigns.",
    angle: "135deg",
  ...
  },
  {
    ...
    icon: faShirt,
    desc: "Driving product discovery and online sales through performance marketing.",
    angle: "160deg",
  ...
  },
  {
    ...
    icon: faSpa,
    desc: "Increasing enquiries, bookings, and brand awareness.",
    angle: "110deg",
    offset: "translate-y-0",
  },
  {
    ...
    icon: faHandshake,
    desc: "Generating qualified leads through targeted advertising strategies.",
    angle: "150deg",
    offset: "lg:translate-y-6",
  },
  {
    ...
    icon: faCartShopping,
    desc: "Supporting customer acquisition and revenue growth through scalable campaigns.",
    angle: "120deg",
    offset: "translate-y-0",
  },
];

export default function MetaAdsIndustries() {
  return (
    <Section id="meta-ads-industries" bgSecondary className="relative overflow-hidden">
