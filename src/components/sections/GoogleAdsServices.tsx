...
const stages = [
  {
    ...
    intro: "Every successful campaign starts with understanding your business goals and target audience.",
    listLabel: "Services Include:",
    items: ["Business Analysis", "Competitor Research", "Keyword Research", "Campaign Planning", "Conversion Strategy"],
  },
  {
    icon: faBullseye,
    title: "Search Ads Management",
    intro: "Appear when customers actively search for your services.",
    listLabel: "Services Include:",
    items: ["Search Campaign Setup", "Keyword Targeting", "Ad Copy Creation", "Bid Management", "Performance Optimization"],
  },
  {
    icon: faImage,
    title: "Display Advertising",
    intro: "Increase visibility through targeted display campaigns.",
    listLabel: "Services Include:",
    items: ["Banner Advertising", "Audience Targeting", "Remarketing Campaigns", "Brand Awareness Campaigns"],
  },
  {
    icon: faCartShopping,
    title: "Shopping Ads",
    intro: "Ideal for ecommerce businesses looking to promote products directly within Google search results.",
    listLabel: "Services Include:",
    items: ["Product Feed Setup", "Merchant Center Configuration", "Shopping Campaign Management", "Product Performance Optimization"],
  },
  {
    icon: faArrowsRotate,
    title: "Remarketing Campaigns",
    intro: "Reconnect with visitors who have already interacted with your website or brand.",
    listLabel: "Services Include:",
    items: ["Audience Segmentation", "Dynamic Remarketing", "Conversion Optimization"],
  },
  {
    icon: faChartLine,
    title: "Reporting & Optimization",
    intro: "Continuous monitoring and improvement.",
    listLabel: "Services Include:",
    items: ["Monthly Performance Reports", "Keyword Optimization", "Budget Management", "Conversion Tracking", "Strategic Recommendations"],
  },
];

export default function GoogleAdsServices() {
  return (
    <Section id="google-ads-services" className="relative overflow-hidden">
      ...
      <Container className="relative !max-w-[1280px] 2xl:!max-w-[1600px]">
        ...
        {/* Flow map — 6 stages this time, evenly spaced, same proven pattern */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="flex flex-1 flex-col items-center gap-2">
            ...
            <span className="max-w-[90px] text-center font-heading text-[10px] font-semibold text-text-secondary/60 2xl:max-w-[100px] 2xl:text-xs">
              Feeds Back Into Reporting
            </span>
          </div>
        </motion.div>

        {/* Service cards — 6 stages, evenly divides 3-column grid, no uneven last row */}
