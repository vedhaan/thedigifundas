...
const features = [
  ...
  { icon: faBoxOpen, title: "Product Catalogue Setup" },
  { icon: faCreditCard, title: "Payment Gateway Integration" },
  { icon: faTruck, title: "Shipping Configuration" },
  { icon: faUserGear, title: "Customer Account System" },
  { icon: faWhatsapp, title: "WhatsApp Integration" },
  { icon: faEnvelopeOpenText, title: "Email Marketing Integration" },
  { icon: faMagnifyingGlassChart, title: "Basic SEO Setup" },
  { icon: faChartLine, title: "Analytics Integration" },
  { icon: faGaugeHigh, title: "Speed Optimization" },
];

export default function EcommerceFeatures() {
  return (
    <Section id="ecommerce-features" bgSecondary className="relative overflow-hidden">
      ...
      <Container className="relative !max-w-[1280px] 2xl:!max-w-[1600px]">
        ...
        {/* full-width feature grid — distinct icon per feature, spans the
            real container width instead of a narrow centered panel */}
