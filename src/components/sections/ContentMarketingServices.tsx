...
const stages = [
  {
    ...
    intro: "Audience research and content planning.",
    listLabel: null,
    items: [],
  },
  {
    ...
    title: "SEO Content",
    intro: "Content optimized for search engines and users.",
    listLabel: null,
    items: [],
  },
  {
    icon: faPenNib,
    title: "Blog Writing",
    intro: "Industry-focused blogs designed to improve visibility.",
    listLabel: null,
    items: [],
  },
  {
    icon: faBookOpen,
    title: "Lead Magnets",
    intro: "E-books, guides, and downloadable resources.",
    listLabel: null,
    items: [],
  },
  {
    ...
    intro: "Helping content reach the right audience.",
    listLabel: null,
    items: [],
  },
];
...
export default function ContentMarketingServices() {
  return (
    <Section id="content-marketing-services" className="relative overflow-hidden">
      ...
      <Container className="relative !max-w-[1280px] 2xl:!max-w-[1600px]">
        ...
        {/* Flow map — same proven pattern as SMM / Meta Ads / Google Ads */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* Service cards — same numbered ghost-digit pattern, i===0 spans two
            columns to balance the 5-item / 3-col grid, same fix as Meta Ads */}
