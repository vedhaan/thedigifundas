...
const steps = [
  { icon: faMagnifyingGlass, title: "Discovery", desc: "Understanding your business, audience, and brand goals." },
  { icon: faBinoculars, title: "Research", desc: "Exploring competitors, industry trends, and design opportunities." },
  { icon: faLightbulb, title: "Concept Development", desc: "Creating design concepts aligned with your brand identity." },
  { icon: faSliders, title: "Refinement", desc: "Reviewing, improving, and finalizing designs." },
  { icon: faBoxOpen, title: "Delivery", desc: "Providing organized, high-quality design files ready for use." },
];

export default function BrandingProcess() {
  return (
    <Section id="branding-process" className="relative overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-body text-sm text-text-secondary">
                A structured 5-phase process, refined across every brand we design for.
              </span>
            </div>
