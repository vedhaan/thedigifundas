...
import { faShirt, faGem, faSpa, faHandshake, faShop } from "@fortawesome/free-solid-svg-icons";
...
const industries = [
  {
    ...
    icon: faShirt,
    desc: "Creating premium digital experiences that reflect brand identity.",
    angle: "135deg",
  ...
  },
  {
    ...
    icon: faGem,
    desc: "Showcasing collections through elegant and user-friendly website designs.",
    angle: "160deg",
  ...
  },
  {
    ...
    icon: faSpa,
    desc: "Helping businesses attract customers and generate appointments online.",
    angle: "110deg",
    offset: "translate-y-0",
  },
  {
    ...
    icon: faHandshake,
    desc: "Building trust and generating qualified enquiries.",
    angle: "150deg",
    offset: "lg:translate-y-6",
  },
  {
    ...
    icon: faShop,
    desc: "Strengthening online visibility and customer engagement.",
    angle: "120deg",
    offset: "translate-y-0",
  },
];

export default function BusinessWebsiteIndustries() {
  return (
    <Section id="business-website-industries" className="relative overflow-hidden">
