...
const stages: Stage[] = [
  {
    ...
    intro: "Every successful online store begins with a strong foundation.",
    lists: [
      {
        label: "Services Include:",
        items: ["Business Requirement Analysis", "Store Structure Planning", "Customer Journey Mapping", "Product Category Strategy"],
      },
    ],
  },
  {
    ...
    intro: "Your website should reflect your brand identity while creating a smooth shopping experience.",
    lists: [
      {
        label: "Services Include:",
        items: ["Custom Homepage Design", "Product Page Design", "Collection Page Design", "Checkout Experience Design", "Mobile Optimization"],
      },
    ],
  },
  {
    ...
    intro: "Modern websites built for performance and scalability.",
    lists: [
      { label: "Platforms:", items: ["Shopify", "WooCommerce", "Next.js Ecommerce Solutions"] },
      {
        label: "Features Include:",
        items: ["Product Management", "Inventory Integration", "Payment Gateway Setup", "Shipping Configuration", "Customer Account Functionality"],
      },
    ],
  },
  {
    ...
    intro: "Helping visitors become customers.",
    lists: [
      {
        label: "Services Include:",
        items: ["Conversion-Focused Design", "Cart Optimization", "Product Page Optimization", "Checkout Flow Improvements", "Lead Capture Integration"],
      },
    ],
  },
  {
    ...
    intro: "Building stores that are search engine friendly from day one.",
    lists: [
      {
        label: "Services Include:",
        items: ["Technical SEO Setup", "Meta Tags", "Product SEO", "Schema Markup", "Site Speed Optimization"],
      },
    ],
  },
];
...
export default function EcommerceServices() {
  return (
    <Section id="ecommerce-services" className="relative overflow-hidden">
      ...
      <Container className="relative !max-w-[1280px] 2xl:!max-w-[1600px]">
        ...
        {/* Flow map — same proven pattern across all four prior pages */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* Service cards — extended to support an optional second labeled list */}
        <div className="mx-auto mt-14 grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {stages.map((stage, i) => (
            ...
            >
              ...
              {/* renders one or two lists depending on the stage's data */}
              {stage.lists.map((list) => (
                <div key={list.label} className="relative mt-5 border-t border-border pt-4 first:mt-5">
