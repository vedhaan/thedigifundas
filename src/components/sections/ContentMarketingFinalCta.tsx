...
export default function ContentMarketingFinalCta() {
  return (
    <section className="relative overflow-hidden bg-bg-primary py-20 sm:py-24 lg:py-28">
      {/* layered glow + subtle grid — no color-mix(), plain gradients only */}
      ...
      {/* diagonal light sweep — animated, pure gradient, no color-mix() */}
      <motion.div
        animate={{ x: ["-30%", "130%"] }}
      ...
      <Container className="relative !max-w-[1280px] 2xl:!max-w-[1600px]">
        ...
        >
          <h2 className="font-heading text-3xl font-bold leading-tight text-text-primary sm:text-4xl lg:text-[3rem]">
            Let&apos;s Build A{" "}
